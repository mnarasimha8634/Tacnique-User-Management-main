...
function App() {
 ...
 async function handleDelete() {
  ...
  function handleLogout() {
    ...
    return (
    <div className="mx-auto min-h-screen w-[95%] max-w-[1450px] py-8 max-md:w-[96%] max-md:py-5">
      ...
      <div className="mb-5 flex flex-wrap items-start gap-4 max-[992px]:flex-col">
      ...
      {loading && (
        <div className="mt-6 rounded-lg border border-slate-200 bg-white p-10 text-center shadow-sm">
          <h2 className="text-base font-semibold text-slate-600">Loading users...</h2>
        </div>
      )}

      {!loading && error && (
        <div className="mt-6 rounded-lg border border-red-200 bg-red-50 p-10 text-center text-red-700 shadow-sm">
          <h3>{error}</h3>
        </div>
      )}
